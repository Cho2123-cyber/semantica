...
- **[Pipeline Composition](https://github.com/semantica-agi/semantica/blob/main/cookbook/advanced/15_Pipeline_Composition.ipynb)** — Reusing whole pipelines: chaining, merging into parallel branches, and nesting sub-pipelines. Topics: PipelineComposer, Namespacing, Sub-Pipelines · *Advanced*
